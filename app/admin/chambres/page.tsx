  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">Chambres</h1>
        <Link
      ...
      {chambres.length === 0 ? (
        <div className="text-center py-16 bg-white rounded-xl border border-gray-200">
          <p className="text-gray-400 text-sm">Aucune chambre pour l&apos;instant.</p>
          <Link
            href="/admin/chambres/new"
        ...
        <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
          {chambres.map((chambre) => (
            <div key={chambre.id} className="flex items-center justify-between px-5 py-4">
              <div>
                <p className="text-sm font-medium text-gray-900">{chambre.name}</p>
